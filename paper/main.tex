...
Given more time, we would like to have followed in the footsteps of \citet{lai2025action} and used a cost-sensitive actor-critic RL model to better understand the response patterns of our human participants.
...
One could imagine a line of future research that studies policy compression under increasingly sophisticated demands, such as commercial videogames with complex reward structures, spatial navigation challenges, or economic decisions.
